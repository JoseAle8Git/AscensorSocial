		...
		<div class="space-y-10">
			...
			>
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
					...
					<!-- Interpretación -->
					<article class="text-slate-600 text-sm space-y-3">
						...
						<p>
							En una sociedad totalmente igualitaria la línea sería diagonal (45º). En cambio, aquí
							vemos que los hijos de hogares con rentas bajas tienden a mejorar su posición, los de
							rentas medias se mantienen relativamente estables y los de rentas altas concentran
							ventajas persistentes, especialmente a partir del centil 80.
						</p>
						<p class="font-semibold text-blue-700">Conclusión</p>
						<p>
							España presenta cierta movilidad ascendente en la parte baja de la distribución, pero
							también una fuerte persistencia en la parte alta: quién nace muy arriba tiene muchas
							más probabilidades de seguir estándolo.
						</p>
					</article>
				</div>
			</section>
			...
			>
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
					...
					<article class="text-slate-600 text-sm space-y-3">
						<h3 class="font-semibold text-blue-700">¿Qué muestra la gráfica?</h3>
						<p>
							Cada barra representa una comunidad autónoma y el centil medio que alcanzan los hijos
							cuando los padres se sitúan en el centil 20 de renta nacional.
						</p>
						<p>
							Las CCAA con barras más largas son aquellas donde los hijos de hogares modestos
							consiguen situarse más arriba en la distribución de renta. Las que aparecen más abajo
							reflejan contextos donde el ascenso es más difícil.
						</p>
						<p class="font-semibold text-blue-700">Conclusión</p>
						<p>
			...
			>
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
					...
					<article class="text-slate-600 text-sm space-y-3">
						<h3 class="font-semibold text-blue-700">¿Qué muestra la gráfica?</h3>
						<p>
							Cada celda recoge la probabilidad (en porcentaje) de que un hijo termine en un quintil
							de renta determinado, dado el quintil de renta de sus padres. Los colores más intensos
							indican transiciones más frecuentes.
						</p>
						<p>
							La diagonal refleja la persistencia: hijos que permanecen en el mismo quintil que sus
							padres. Las celdas por encima de la diagonal muestran movilidad ascendente y las que
							están por debajo, movilidad descendente.
						</p>
						<p class="font-semibold text-blue-700">Conclusión</p>
						<p>
			...
			>
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
					...
					<article class="text-slate-600 text-sm space-y-3">
						...
						<p>
							El usuario elige un centil de renta para los padres. A partir de la curva nacional de
							movilidad se obtiene el centil esperado del hijo utilizando la estimación suavizada
							(LOESS).
						</p>
						<p>
							Después, se consulta el conversor de centiles a euros para los padres y para los
							hijos: cada centil tiene asociada una renta media. Así se obtiene la renta estimada de
							origen y de destino.
						</p>
						<p>
							Finalmente, se compara el centil del hijo con el de los padres para clasificar el caso
							como movilidad ascendente, descendente o estabilidad, y se muestra una interpretación
							automática.
						</p>
						<p class="font-semibold text-blue-700">Conclusión</p>
						<p>
...
<footer class="border-t border-slate-800 bg-slate-900 py-8 px-6">
	<div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-400 text-sm">
		<div class="mx-auto">
		...
		<div class="mx-auto">
			<h3 class="text-center font-semibold text-blue-400 mb-3">Enlaces útiles</h3>
	...
	<div>
		<div class="mt-8 pt-4 border-t border-slate-800 text-center text-xs text-slate-600">
