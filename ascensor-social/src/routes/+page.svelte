...
<main class="min-h-screen bg-zinc-950 text-slate-100">
    <div class="mx-auto max-w-6xl px-4 py-8 space-y-8">
        ...
        <header id="top" class="space-y-2">
            Dashboard del Ascensor Social
        </header>
        <p class="text-slate-300 max-w-2xl">
            Visualización interactiva de la movilidad intergeneracional de la renta en España: curvas de movilidad, diferencias territoriales y conversión de centiles a euros.
        </p>
        ...
        <div class="space-y-10">
            ...
            <section class="bg-white border border-slate-200 rounded-xl p-6 lg:p-8 shadow-lg">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <article class="text-slate-700 text-sm space-y-3">
                        ...
                        <p>
                            En una sociedad totalmente igualitaria la línea sería diagonal (45º). En cambio, aquí vemos
                            que los hijos de hogares con rentas bajas tienden a mejorar su posición, los de rentas medias
            ...
            <section class="bg-white border border-slate-200 rounded-xl p-6 lg:p-8 shadow-lg">
                <header class="mb-4">
                    ...
                    <p class="text-slate-300 text-sm">
                        Centil medio de los hijos cuando los padres están en el 20&nbsp;% inferior de la distribución.
                    </p>
                </header>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <!-- Gráfica -->
                    ...
                    <article class="text-slate-700 text-sm space-y-3">
                        ...
                        <p>
                            Las CCAA con barras más largas son aquellas donde los hijos de hogares modestos consiguen
            ...
            <section class="bg-white border border-slate-200 rounded-xl p-6 lg:p-8 shadow-lg">
                <header class="mb-4">
                    ...
                    <p class="text-slate-300 text-sm">
                        Probabilidades de pasar de un quintil de origen a un quintil de destino en la distribución de renta.
                    </p>
                </header>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <!-- Gráfica -->
                    ...
                    <article class="text-slate-700 text-sm space-y-3">
                        ...
                        <p>
                            La diagonal refleja la persistencia: hijos que permanecen en el mismo quintil que sus padres.
            ...
            <section class="bg-white border border-slate-200 rounded-xl p-6 lg:p-8 shadow-lg">
                ...
                <h2 class="text-xl font-semibold text-white">Conversor de centiles a euros</h2>
                    <p class="text-slate-300 text-sm">
                        Equivalencia entre posición en la distribución (centil) y renta media en euros para padres e hijos,
                        y simulación del “ascensor social”.
                    </p>
                </header>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <!-- Simulador -->
                    ...
                    <article class="text-slate-700 text-sm space-y-3">
                        ...
                        <p>
                            Después, se consulta el conversor de centiles a euros para los padres y para los hijos: cada centil
                            tiene asociada una renta media. Así se obtiene la renta estimada de origen y de destino.
                        </p>
                        <p>
...
<footer class="border-t border-slate-200 bg-slate-900 py-8 px-6">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-300 text-sm">
        <div class="mx-auto">
            ...
            <p class="text-center">
                Visualización de de movilidad intergeneracional, basada en datos reales de distribución de renta y modelos
                de movilidad social.
            </p>
        </div>
        <div class="mx-auto">
            ...
            <ul class="space-y-2">
                ...
                <li><a class="hover:text-white transition" href="https://github.com/JoseAle8Git/AscensorSocial" target="_blank">GitHub Repository</a></li>
                <li><a class="hover:text-white transition" href="https://tailwindcss.com" target="_blank">TailwindCSS</a></li>
            </ul>
        </div>
        <div class="mx-auto">
            <h3 class="text-center font-semibold text-sky-400 mb-3">Autor</h3>
            <p class="text-center">
                Proyecto desarrollado por <span class="text-white font-medium">Jose Alejandro, Alireza, Alberto</span>.
